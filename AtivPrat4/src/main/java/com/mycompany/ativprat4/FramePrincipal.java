...
public class FramePrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        NovoSetor = new javax.swing.JMenuItem();
        Organograma = new javax.swing.JMenuItem();
        ...
        NovoSetor.setText("Novo");
        NovoSetor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NovoSetorActionPerformed(evt);
            }
        });
        jMenu3.add(NovoSetor);

        Organograma.setText("Organograma");
        Organograma.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OrganogramaActionPerformed(evt);
            }
        });
        jMenu3.add(Organograma);
    ...
    private void menuEmpresaListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEmpresaListarActionPerformed
        // TODO add your handling code here:
        DialogListaEmpresas lista = new DialogListaEmpresas();
        lista.setVisible(true);
    }//GEN-LAST:event_menuEmpresaListarActionPerformed

    private void NovoSetorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NovoSetorActionPerformed
        DialogSetor form = new DialogSetor(this,true);
        form.setVisible(true);
        Setor retorno = form.getModalResult();
        if (retorno != null) {
            empresa.getSetores().add(retorno);
	}
    }//GEN-LAST:event_NovoSetorActionPerformed

    private void OrganogramaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrganogramaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_OrganogramaActionPerformed
    ...
    private javax.swing.JMenuItem NovoSetor;
    private javax.swing.JMenuItem Organograma;
