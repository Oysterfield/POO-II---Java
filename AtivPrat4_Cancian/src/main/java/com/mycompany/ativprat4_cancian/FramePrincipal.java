...
public class FramePrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuEmpresaNova.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.SHIFT_DOWN_MASK));
    ...
    private void menuArquivoNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuArquivoNovoActionPerformed
        ...
        fileChooser.setFileSelectionMode(WIDTH);
    ...
    private void menuArquivoAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuArquivoAbrirActionPerformed
        ...
        //
        if (empresas.size()>0) {
            if (JOptionPane.NO_OPTION == JOptionPane.showConfirmDialog(this, "Já existem empresas. Deseja sobrescrevelas?")
            return;
        }
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            while (!acabou) {
                try {
                    empresaAtual = Empresa.leia(arquivoAtual);
                    this.empresas.add(empresaAtual);
                } catch (IOException ex) {
                    Logger.getLogger(FramePrincipal.class.getName()).log(Level.SEREVE, null, ex);
                    acabou = true;
                }
            }
        }
        // Desserialize o arquivo, criando instâncias das empresas que estavam salvas 
        // ...
        AtualizaMenus(); // não é bom o mesmo código aparecer em muitos lugares
    ...
    private void menuArquivoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuArquivoSalvarActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            for (Empresa e: empresas) {
                try {
                e.salve(arquivoAtual);
            } catch (IOException ex) {
                Logger.getLogger(FramePrincipal.class.getName()).log(Level.SEVERE, null, ex); resourceBundleName)
