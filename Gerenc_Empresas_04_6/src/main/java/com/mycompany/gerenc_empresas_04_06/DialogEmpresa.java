...
public class DialogEmpresa extends javax.swing.JDialog {
    ...
    private Endereco enderedoDaEmpresa;
    ...
    public void setModel(Empresa model) {
        ...
        if (model != null) {
            ...
            Endereco ender = model.getEndereco();
            if (ender != null) {
                textEnderecoNaoEditavel.setText(ender.toString());
            }
    ...
    private void buttonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOkActionPerformed
        try {
            ...
            model = new Empresa(textNome.getText(), textCNPJ.getText(), AreaDeAtividade.values()[indexArea], enderedoDaEmpresa);
    ...
    private void buttonEnderecoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEnderecoActionPerformed
        ...
        Endereco retorno = form.GetModel();
        if (retorno != null) {
            enderedoDaEmpresa = retorno;
