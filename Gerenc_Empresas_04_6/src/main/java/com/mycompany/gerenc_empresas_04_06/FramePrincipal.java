...
public class FramePrincipal extends javax.swing.JFrame {
    ...
    private void menuArquivoAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuArquivoAbrirActionPerformed
        // TODO add your handling code here:
        if (empresas.size()>0) {
            if (JOptionPane.NO_OPTION == JOptionPane.showConfirmDialog(this, "Já existem empresas. Deseja sobrescrevê-las?", "Abrir Empresas", JOptionPane.QUESTION_MESSAGE)) {
                return;
            }
        }
    ...
    private void menuArquivoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuArquivoSalvarActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            for (Empresa empresa : empresas) {
                try {
                    empresa.salve(arquivoAtual);
                } catch (IOException ex) {
                    Logger.getLogger(FramePrincipal.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(this, "Erro ao salvar o arquivo: " + ex.getMessage(), "Deu Ruim", JOptionPane.WARNING_MESSAGE);
                }
            }
        }
